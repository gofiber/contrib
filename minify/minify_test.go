...
func init() {
	// set expected data
	data, err := os.ReadFile("../.github/testdata/minify_expected_data.yaml")
	if err != nil {
	...
	// set file data
	html, err := os.ReadFile("../.github/testdata/template.html")
	if err != nil {
		panic(err)
	}
	filedata.html = html
	filedata.htmlWithCss, err = os.ReadFile("../.github/testdata/template-with-css.html")
	if err != nil {
		panic(err)
	}
	filedata.htmlWithJs, err = os.ReadFile("../.github/testdata/template-with-js.html")
	if err != nil {
		panic(err)
	}
	filedata.htmlWithCssAndJs, err = os.ReadFile("../.github/testdata/template-with-css-and-js.html")
	if err != nil {
		panic(err)
	}
	filedata.css, err = os.ReadFile("../.github/testdata/template.css")
	if err != nil {
		panic(err)
	}
	filedata.js, err = os.ReadFile("../.github/testdata/template.js")
	if err != nil {
		panic(err)
	}
}
