...
> This module targets **Casbin v3**. If you still depend on Casbin v2, use the
> previous major of this middleware (`github.com/gofiber/contrib/v3/casbin`),
> which is deprecated and frozen. Migrating from Casbin v2 to v3 is mostly an
> import-path change; see the [Casbin upgrade guide](https://casbin.org/docs/upgrade).
