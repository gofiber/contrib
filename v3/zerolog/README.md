...
| SkipField        | `func(string, fiber.Ctx) bool`                     | Skip logging the field if returns true.                                                                                                                                                                                                                                                               | `nil`                            |
| SkipHeader        | `func(string, fiber.Ctx) bool`                     | Skip logging header if returns true.                                                                                                                                                                                                                                                               | `nil`                            |
